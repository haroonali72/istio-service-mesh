...
type CronJobServiceAttribute struct {
	...
	StartingDeadLineSeconds    *StartingDeadlineSeconds    `json:"startingDeadlineSeconds,omitempty"`
	ConcurrencyPolicy          *ConcurrencyPolicy          `json:"concurrencyPolicy,omitempty"`
	Suspend                    *Suspend                    `json:"suspend,omitempty"`
	FailedJobsHistoryLimit     *FailedJobsHistoryLimit     `json:"failedJobsHistoryLimit,omitempty"`
	SuccessfulJobsHistoryLimit *SuccessfulJobsHistoryLimit `json:"successfulJobsHistoryLimit,omitempty"`
	JobServiceAttribute        *JobServiceAttribute        `json:"jobTemplate,omitempty"`
}
