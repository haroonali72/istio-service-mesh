...
type VirtualService struct {
	...
	ServiceSubType    string              `json:"service_sub_type" bson:"service_sub_type"`
	Name              string              `json:"name" bson:"name"`
	Namespace         string              `json:"namespace" bson:"namespace"`
	ServiceAttributes *VSServiceAttribute `json:"service_attributes" bson:"service_attributes"`
}
...
type Http struct {
	...
	Retries        *HttpRetry          `json:"retries" bson:"retries"`
...
type HttpFaultInjection struct {
	DelayType string `json:"delay_type" bson:"delay_type"`
	//deplay value in ms
	DelayValue      float64 `json:"delay_value" bson:"delay_value"`
...
type HttpCorsPolicy struct {
	...
	//max age in ms
	MaxAge           int64 `json:"max_age" bson:"max_age"`
