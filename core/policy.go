...
//}
//
//func getPolicy(input *pb.PolicyService) (*istioClient.PeerAuthentication, error) {
////	var policyServ = new(istioClient.AuthorizationPolicy)
////	labels := make(map[string]string)
////	labels["app"] = strings.ToLower(input.Name)
////	labels["version"] = strings.ToLower(input.Version)
////	policyServ.Labels = labels
////	policyServ.Kind = constants.MeshPolicy.String() //"Policy"
////	policyServ.APIVersion = "authentication.policy.io/v1beta1"
////	policyServ.Name = input.Name
////	policyServ.Namespace = input.Namespace
////	for _, t := range input.ServiceAttributes.Target {
////		target := v1beta1.WorkloadSelector{}
////		target.Labels[t.Name] = t.Name
////
////		if t.Ports != nil {
...
//}
//
//func getPolicyRequestObject(req *pb.PolicyService) (*istioClient.AuthorizationPolicy, error) {
//	_, err := getPolicy(req)
//	if err != nil {
//		utils.Error.Println(err)
//
