...
func (s *KubernetesServer)CreateKubernetesService(ctx context.Context,req *pb.KubernetesService)(*pb.ServiceResponse,error){
...
func (s *KubernetesServer)GetKubernetesService(ctx context.Context,req *pb.KubernetesService)(*pb.ServiceResponse,error){
	serviceResp := new(pb.ServiceResponse)
	serviceResp.Status = &pb.ServiceStatus{
		Id: req.ServiceId,
		ServiceId: req.ServiceId,
...
func (s *KubernetesServer)DeleteKubernetesService(ctx context.Context,req *pb.KubernetesService)(*pb.ServiceResponse,error){
	serviceResp := new(pb.ServiceResponse)
	serviceResp.Status = &pb.ServiceStatus{
		Id: req.ServiceId,
		ServiceId: req.ServiceId,
...
func (s *KubernetesServer)PatchKubernetesService(ctx context.Context,req *pb.KubernetesService)(*pb.ServiceResponse,error){
	serviceResp := new(pb.ServiceResponse)
	serviceResp.Status = &pb.ServiceStatus{
		Id: req.ServiceId,
		ServiceId: req.ServiceId,
...
func (s *KubernetesServer)PutKubernetesService(ctx context.Context,req *pb.KubernetesService)(*pb.ServiceResponse,error){
	serviceResp := new(pb.ServiceResponse)
	serviceResp.Status = &pb.ServiceStatus{
		Id: req.ServiceId,
		ServiceId: req.ServiceId,
...
func getKubernetesService(input *pb.KubernetesService) (*istioClient.Gateway, error) {
...
func getKubernetesServiceSpec() (v1alpha3.Gateway, error) {
...
func getKubernetesRequestObject(req *pb.KubernetesService)(*istioClient.Gateway, error){
