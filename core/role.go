...
func getRole(input *pb.RoleService) (*istioClient.Gateway, error) {
...
func getRoleSpec() (v1alpha3.Gateway, error) {
...
func getRoleRequestObject(req *pb.RoleService)(*istioClient.Gateway, error){
