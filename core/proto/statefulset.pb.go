...
type StatefulSetServiceAttributes struct {
	...
	TerminationGracePeriodSeconds *TerminationGracePeriodSeconds  `protobuf:"bytes,17,opt,name=terminationGracePeriodSeconds,proto3" json:"terminationGracePeriodSeconds,omitempty"`
	VolumeClaimTemplates          []*PersistentVolumeClaimService `protobuf:"bytes,18,rep,name=volumeClaimTemplates,proto3" json:"volumeClaimTemplates,omitempty"`
	PodManagementPolicy           PodManagementPolicyType         `protobuf:"varint,19,opt,name=podManagementPolicy,proto3,enum=proto.PodManagementPolicyType" json:"podManagementPolicy,omitempty"`
	XXX_NoUnkeyedLiteral          struct{}                        `json:"-"`
	XXX_unrecognized              []byte                          `json:"-"`
	XXX_sizecache                 int32                           `json:"-"`
}
...
var fileDescriptor_4f0a4b9f0c7482c8 = []byte{
	...
	,
}
