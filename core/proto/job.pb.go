...
type JobServiceAttribute struct {
	...
	ActiveDeadlineSeconds   *ActiveDeadlineSeconds          `protobuf:"bytes,3,opt,name=activeDeadlineSeconds,proto3" json:"activeDeadlineSeconds,omitempty"`
	BackofLimit             *BackoffLimit                   `protobuf:"bytes,4,opt,name=backofLimit,proto3" json:"backofLimit,omitempty"`
	...
	ManualSelector          *ManualSelector                 `protobuf:"bytes,6,opt,name=manualSelector,proto3" json:"manualSelector,omitempty"`
	...
	TtlSecondsAfterFinished *TTLSecondsAfterFinished        `protobuf:"bytes,11,opt,name=ttlSecondsAfterFinished,proto3" json:"ttlSecondsAfterFinished,omitempty"`
	...
	Containers              map[string]*ContainerAttributes `protobuf:"bytes,22,rep,name=containers,proto3" json:"containers,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	InitContainers          map[string]*ContainerAttributes `protobuf:"bytes,23,rep,name=initContainers,proto3" json:"initContainers,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	XXX_NoUnkeyedLiteral    struct{}                        `json:"-"`
	XXX_unrecognized        []byte                          `json:"-"`
	XXX_sizecache           int32                           `json:"-"`
}
...
func (m *JobServiceAttribute) GetBackofLimit() *BackoffLimit {
	if m != nil {
		return m.BackofLimit
	}
	return nil
}
...
func (m *JobServiceAttribute) GetContainers() map[string]*ContainerAttributes {
	if m != nil {
		return m.Containers
	}
	return nil
...
func (m *JobServiceAttribute) GetInitContainers() map[string]*ContainerAttributes {
	if m != nil {
...
func init() {
	...
	proto.RegisterMapType((map[string]*ContainerAttributes)(nil), "proto.JobServiceAttribute.ContainersEntry")
	proto.RegisterMapType((map[string]*ContainerAttributes)(nil), "proto.JobServiceAttribute.InitContainersEntry")
...
var fileDescriptor_f32c477d91a04ead = []byte{
	...
	,
}
