...
func (s *ServiceAccountServer)CreateServiceAccount(ctx context.Context,req *pb.ServiceAccountService)(*pb.ServiceResponse,error){
	...
	ksdRequest ,err := getServiceAccountRequestObject(req)
...
func (s *ServiceAccountServer)GetServiceAccount(ctx context.Context,req *pb.ServiceAccountService)(*pb.ServiceResponse,error){
	serviceResp := new(pb.ServiceResponse)
	serviceResp.Status = &pb.ServiceStatus{
		Id: req.ServiceId,
		ServiceId: req.ServiceId,
...
func (s *ServiceAccountServer)DeleteServiceAccount(ctx context.Context,req *pb.ServiceAccountService)(*pb.ServiceResponse,error){
	serviceResp := new(pb.ServiceResponse)
	serviceResp.Status = &pb.ServiceStatus{
		Id: req.ServiceId,
		ServiceId: req.ServiceId,
...
func (s *ServiceAccountServer)PatchServiceAccount(ctx context.Context,req *pb.ServiceAccountService)(*pb.ServiceResponse,error){
	serviceResp := new(pb.ServiceResponse)
	serviceResp.Status = &pb.ServiceStatus{
		Id: req.ServiceId,
		ServiceId: req.ServiceId,
...
func (s *ServiceAccountServer)PutServiceAccount(ctx context.Context,req *pb.ServiceAccountService)(*pb.ServiceResponse,error){
	serviceResp := new(pb.ServiceResponse)
	serviceResp.Status = &pb.ServiceStatus{
		Id: req.ServiceId,
		ServiceId: req.ServiceId,
...
func getServiceAccount(input *pb.ServiceAccountService) (*istioClient.Gateway, error) {
...
func getServiceAccountSpec() (v1alpha3.Gateway, error) {
...
func getServiceAccountRequestObject(req *pb.ServiceAccountService)(*istioClient.Gateway, error){
