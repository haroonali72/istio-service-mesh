...
type StatefulSetServiceAttribute struct {
	...
	UpdateStrategy                *StateFulSetUpdateStrategy     `json:"update_Strategy,omitempty"`
	Containers                    []*ContainerAttribute          `json:"containers,omitempty"`
	InitContainers                []*ContainerAttribute          `json:"init_containers,omitempty"`
	PodManagementPolicy           PodManagementPolicyType        `json:"pod_management_policy,omitempty"`
	...
	TerminationGracePeriodSeconds *TerminationGracePeriodSeconds `json:"termination_grace_period_seconds,omitempty"`
	VolumeClaimTemplates          []PersistentVolumeClaimService `json:"volume_claim_templates, omitempty"`
}
