...
type ServiceBasicInfo struct {
	...
	// +mandatory
	Name string `json:"name"  bson:"name" binding:"required" valid:"alphanumspecial,length(5|50),lowercase~service name is invalid. Valid regex is ^[ A-Za-z0-9_-]*$,required"`
