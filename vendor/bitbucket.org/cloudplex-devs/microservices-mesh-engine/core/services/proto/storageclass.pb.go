...
type StorageClassAttributes struct {
	...
	AllowVolumeExpansion string                  `protobuf:"bytes,2,opt,name=allow_volume_expansion,json=allowVolumeExpansion,proto3" json:"allow_volume_expansion,omitempty"`
	Provisioner          string                  `protobuf:"bytes,3,opt,name=provisioner,proto3" json:"provisioner,omitempty"`
	ScParameters         *Parameters             `protobuf:"bytes,4,opt,name=sc_parameters,json=scParameters,proto3" json:"sc_parameters,omitempty"`
...
type Parameters struct {
	GcpPdScParm          map[string]string `protobuf:"bytes,1,rep,name=gcp_pd_sc_parm,json=gcpPdScParm,proto3" json:"gcp_pd_sc_parm,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	AwsEbsScParm         map[string]string `protobuf:"bytes,2,rep,name=aws_ebs_sc_parm,json=awsEbsScParm,proto3" json:"aws_ebs_sc_parm,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	AzureDiskScParm      map[string]string `protobuf:"bytes,3,rep,name=azure_disk_sc_parm,json=azureDiskScParm,proto3" json:"azure_disk_sc_parm,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	AzureFileScParm      map[string]string `protobuf:"bytes,4,rep,name=azure_file_sc_parm,json=azureFileScParm,proto3" json:"azure_file_sc_parm,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	XXX_NoUnkeyedLiteral struct{}          `json:"-"`
	XXX_unrecognized     []byte            `json:"-"`
	XXX_sizecache        int32             `json:"-"`
}
...
func (m *Parameters) GetAzureDiskScParm() map[string]string {
	if m != nil {
		return m.AzureDiskScParm
	}
	return nil
}

func (m *Parameters) GetAzureFileScParm() map[string]string {
	if m != nil {
		return m.AzureFileScParm
	}
	return nil
}
...
func init() {
	...
	proto.RegisterMapType((map[string]string)(nil), "proto.Parameters.AzureDiskScParmEntry")
	proto.RegisterMapType((map[string]string)(nil), "proto.Parameters.AzureFileScParmEntry")
...
var fileDescriptor_a3943d2b4f3af7d5 = []byte{
	...
	,
}
